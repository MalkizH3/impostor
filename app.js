...
function wireEvents() {
  ...
  els.wordModeRandom.addEventListener("change", () => updateWordMode("random")); els.wordModeCustom.addEventListener("change", () => updateWordMode("custom")); els.customWordSaveBtn.addEventListener("click", submitCustomWord); els.customWordInput.addEventListener("keydown", (event) => { if (event.key === "Enter") submitCustomWord(); });
